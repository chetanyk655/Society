  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Login',style: TextStyle(color: Colors.white, fontSize: 20)),
      ),
      body: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              const Text('Login to your Account',style: TextStyle(color: Colors.white, fontSize: 24,),),
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      MaterialPageRoute(builder: (context)=>const DashBoardFinal()) );
                      },
